...
{
    static string SecretKey = "vtfisawesome";
    ...
    public static string Encrypt(string message, string customKey = "")
    {
    ...
    public static string Decrypt(string message, string customKey = "")
    {
        string secretKey = SecretKey;
